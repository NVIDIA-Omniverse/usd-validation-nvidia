...
### Invalid: Material binding references outside payload scope
...
### Valid: Material binding references within payload scope
...
- [USD Material Binding](https://openusd.org/release/api/class_material_binding_a_p_i.html)