...
```{note}
Kinematics may also be described with USDPhysics Joints, in which case the prim hierarchy does not need to reflect the kinematic chain.
```
...
### Invalid: Flat hierarchy ignoring kinematic relationships
