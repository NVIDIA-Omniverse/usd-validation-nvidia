...
|---------------|-------------------------------------|
| Version       | 1.0.0                              |
| Validator     | {validator-latest-link}`scene-optimizer:vg-009` {oav-validator-latest-link}`vg-009` |
...
- Improves file loading performance
- Enables efficient data reuse and sharing
...
- [Scene Optimizer - Index Primvars](https://docs.omniverse.nvidia.com/extensions/latest/ext_scene-optimizer/operations.html)
