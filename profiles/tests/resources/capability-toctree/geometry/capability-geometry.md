...
- **Performance** and proper "topological hygiene" is a key consideration for geometry and an important focus of this capability.
- **USDGeom** also provides other types of geometry, but this documentation focuses on meshes.
- Various other geometry types in USD are also "point based" and may share the same requirements as meshes.
