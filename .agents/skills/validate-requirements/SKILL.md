...
The requirement is authored as Markdown and generated with `usd-profiles-nvidia`; the rule registration, execution, and
CLI filtering stay in `usd-validation-nvidia`.
