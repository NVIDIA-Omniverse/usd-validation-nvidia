...
class LocalUriResolverTests(unittest.TestCase):
    ...
    def test_stateless_equality_ok(self):
        self.assertEqual(LocalUriResolver(), LocalUriResolver())

    def test_pickle_ok(self):
        self.assertEqual(pickle.loads(pickle.dumps(LocalUriResolver())), LocalUriResolver())
