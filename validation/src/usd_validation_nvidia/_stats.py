...
class _Stats:
    ...
    def merge(self, stats: _Stats) -> None:
...
class ValidationStats(_Stats):
    ...
    def merge(self, stats: ValidationStats) -> None:
        super().merge(stats)
        self._time_rule.update(stats._time_rule)
        self._count_rule_severity.update(stats._count_rule_severity)
    ...
    def total_time(self) -> float:
        ...
        return sum(t for _, t in self.get_rule_times())
