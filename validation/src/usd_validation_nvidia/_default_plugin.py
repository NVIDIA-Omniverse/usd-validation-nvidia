...
#
"""
Default plugin for USD Validation NVIDIA.
...
class DefaultPlugin:
    ...
    def on_startup(self) -> None:
        ...
        _register("Geometry", UsdGeomSubsetChecker)
        _register("Geometry", UsdGeomSubsetFamiliesChecker)
        _register("Geometry", UsdGeomSubsetParentIsImageableChecker)
