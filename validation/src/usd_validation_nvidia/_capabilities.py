...
def register_capabilities(capabilities: Iterable[Capability]) -> bool:
    """
    ...
    Returns:
        True if every capability was registered, False if any were skipped.
    """
    flag: bool = True
    for capability in capabilities:
        try:
            ...
            logger.debug(f"Capability {capability} already registered, skipping")
            flag = False
    return flag


def unregister_capabilities(capabilities: Iterable[Capability]) -> bool:
    """
    ...
    Returns:
        True if every capability was unregistered, False if any were skipped.
    """
    flag: bool = True
    for capability in capabilities:
        try:
            ...
            logger.debug(f"Capability {capability} still in use, skipping")
            flag = False
    return flag
